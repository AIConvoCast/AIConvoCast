...
OPUS47_SCRIPT_TUNING_APPENDIX = (
    ...
    "- Target spoken length: roughly 4 to 6 minutes for the main episode body, before the separate intro and outro are added.\n"
    "- Target script length: 3,200 to 4,600 characters. Treat 5,000 characters as a hard ceiling unless extra context is required for factual accuracy.\n"
    "- Make this roughly 30% shorter than prior longer drafts: keep the strongest concrete details and cut repetitive background, broad framing, and weaker metrics.\n"
    "- Cover 2 to 3 distinct stories. Use 3 when they can fit naturally within the character target; otherwise prioritize the strongest 2 stories.\n"
    ...
    "- Spend roughly 1 to 2 concise spoken paragraphs on each major story when the source material supports it.\n"
