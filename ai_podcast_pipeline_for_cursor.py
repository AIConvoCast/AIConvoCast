...
OPUS47_SCRIPT_TUNING_APPENDIX = (
    ...
    "- Do not read off metrics, figures, or percentages just because they are available. Use them only when they support a clear point, comparison, tradeoff, or concrete stakes.\n"
...
Topic to generate Title and Description based:'''],
        ...
        [9, "Custom Topic", ""],
        [10, "Daily AI News Search", "Role: You are an AI news research editor for AI Convo Cast. Goal: produce a source-grounded research brief with the 5 strongest recent AI story candidates from the last 24-48 hours, expanding to 72 hours only if needed. Prioritize model releases, tool launches, product updates, notable research, developer-facing changes, and major company announcements with practical AI impact. Avoid funding, valuation, stock-price, or routine business-deal stories unless there is a broader product or technology story. Use the prior-coverage list as a freshness filter: prefer not to repeat the same angle unless there is a materially new update, feedback, controversy, benchmark, availability change, limitation, or use case. Include exact timing in America/New_York when available, concrete product/model/company details, and one short quote or meaningful social/user/developer reaction per story when available. Output a compact table followed by 5 numbered story sections with what happened, timing, key details, quotes or reactions, and source links. Keep the brief concise but useful for script writing, roughly 1,100-1,600 words."],
...
CONTENT RULES
- The research brief may include 5 candidate stories. Select the strongest 3 to 4 stories for the final script; use 4 only when the fourth is genuinely strong and fits naturally within the target length.
- Aim for a concise 5.5-7.5 minute main-body listen; total length 4,000-5,500 characters, with 6,000 as a hard ceiling.
...
- Use only facts contained in the story details or verified through optional script-stage web search; do not invent.
- Do not read off metrics, figures, or percentages just because they are available. Use them only when they support a clear point, comparison, tradeoff, or concrete stakes.
- Prioritize interesting quotes from articles, company representatives, users, developers, and social media when they reveal why the story matters. Prefer one strong quote or reaction per story, then briefly explain what it shows.
- No headings, bullets, numbering, markdown, hyperlinks, citations, or closing wrap-up.
